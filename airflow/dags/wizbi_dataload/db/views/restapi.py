...
from wizbi_dataload.db.lib.api_connection_factory import APIConnectorFactory
from wizbi_dataload.db.models.models import Pipeline, Rest_Api_Db_Conn
    ...
    def __init__(self,
        ...
        if self.__source_db_conn:
            ...
            if restapi_conn:
                ...
                self.__data_url = restapi_conn.data_url
    ...
    def load_data(self, job_id):
        ...
        try:
            ...
            apiconnector = APIConnectorFactory.get_connector(connector_name,
                                                             ...
                                                             data=self.__body)
            URL = self.__data_url if self.__data_url else self.__url
            ...
            if output:
                ...
                if not parsed_data.empty:
                    ...
                    return True
                # if no data found then update the job status
                else:
                    current_time = datetime.now()
                    ...
                    # raise Exception('Error in getting rest api data')
            ...
            raise Exception(f'Error in getting rest api data:{e}')
